...
const Toast = ({ message, type, isVisible, onClose }) => {
  ...
  return (
    ...
    <div
      className={`fixed top-4 right-4 ${bgColor} text-white px-6 py-3 rounded-lg shadow-lg z-50 transform transition-all duration-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}
    >
...
const Signin = () => {
  ...
  const validateForm = () => {
    ...
    newErrors.emailOrUsername =
      validateEmailOrUsername(formData.emailOrUsername);
  ...
  const handleInputBlur = (e) => {
    ...
    if (name === 'emailOrUsername') {
      ...
      const error = validateEmailOrUsername(value);
  ...
  const handleGoogleSignIn = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/api/auth/google/firebase`,
        {
          credentials: "include",
          method: "POST",
          headers: {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2.5 bg-white/10 ${errors.emailOrUsername ? 'border-red-400 focus:border-red-400 focus:ring-red-400' : 'border-white/20 focus:border-cyan-400 focus:ring-cyan-400'} text-white backdrop-blur-sm border rounded-lg placeholder-gray-400 focus:ring-1 transition-all duration-300`}
              ...
              {errors.password && (
                ...
                <p className="mt-1 text-sm text-red-400 flex items-center">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 01-1 1z"
                      clipRule="evenodd"
                    />
